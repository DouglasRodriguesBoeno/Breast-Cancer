...
BreastCare AI é uma aplicação web educacional de IA para análise preditiva baseada em Machine Learning sobre o dataset **Wisconsin Diagnostic Breast Cancer (WDBC)**.
...
- **Persistência** das análises realizadas;
- **Histórico** de análises;
- **Tela de detalhe** da análise;
- **Resultado explicável** com probabilidades, faixa de risco e notas educacionais.
